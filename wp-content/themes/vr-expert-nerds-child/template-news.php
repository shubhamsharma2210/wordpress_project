...
<section class="ComanBreadcrumb">
   <div class="cst-container">
    ...
    <?php   $term = get_queried_object();
            ...
            $sort_by_filter_heading = get_field('sort_by_filter_heading',$term)?get_field('sort_by_filter_heading',$term):'Sort by';
            $most_popular = get_field('most_popular',$term);
            $newest_heading = get_field('newest_heading',$term);
            $oldest_heading = get_field('oldest_heading',$term);
    ?>
      ...
      <div class="wrap-alltext sideWidth ">
         <div class="Left-news left-Width">
            <div class="News-content">
               <h1 class="HeadingH2-40-bold"><?php echo $term->name; ?></h1>
               <div class ="Google-Buy Editor-class">
               <p class="font-18text "><?php echo $term->description; ?></p>
              </div>
               ...
               <div class="popular-leftmenu">
                  ...
                  <div class="select-dropdown">
                     <button href="#" role="button" data-value="" class="select-dropdown__button">
                        <span><?php echo $newest_heading; ?></span> 
                     ...
                     <ul class="select-dropdown__list">
                        <?php if($most_popular){ ?>
                           <li data-value="mostpopular" id ="mostpopular" class="select-dropdown__list-item "  ><?php echo $most_popular; ?></li>
                        <?php } ?>
                        <?php if($newest_heading){ ?>
                        <li data-value="newest" id = "newest" class="select-dropdown__list-item active"   ><?php echo $newest_heading; ?></li>
                        <?php } ?>
                        <?php if($oldest_heading){ ?>
                        <li data-value="oldest" id = "oldest" class="select-dropdown__list-item" ><?php echo $oldest_heading; ?></li>
                        <?php } ?>
                     </ul>
                     <input type="hidden" id ="sortBy" data-id="<?php echo $term->term_id;  ?>" value="newest"/>
               ...
               <div class="newsItems">
                  ...
                  <div class="News-Allcards">
                     ...
                     <a href="<?php echo get_the_permalink($posts_id); ?>">
                        <img src="<?php echo $featuredurl; ?>" alt="<?php echo get_the_title($posts_id);  ?>"/>
                        </a>
                     </div>
            ...
            <div class="PageBtn mt-125">
               ...
               <a href="javascript:void(0)" id="more_posts" data-max-page="<?php echo $loop->max_num_pages; ?>" class="knowledge-btn guide-clr" onclick="loadmore_func()"><?php echo $more_button_text; ?></a>
            </div>
